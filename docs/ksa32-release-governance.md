...
(3.11)`, and `fast (3.12)`. `heavy` was skipped on the normal PR path. These
facts leave the repository **NOT QUALIFIED** until protection settings and
independent review are actually present and a fresh evidence capture passes.
Fabric did not change GitHub administration or reviewer assignments.
