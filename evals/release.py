        ...
        try:
            ...
            bound = all(
                ...
                for field, actual in (
                    ...
                    ("inference_endpoint_identity", egress.capability("inference_route").endpoint_identity),
                )
            )
            ...
            endpoint_consistent = candidate_spec.get("inference_endpoint_identity") == egress.capability("inference_route").endpoint_identity
