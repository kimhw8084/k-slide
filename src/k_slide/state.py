...
_ALLOWED: dict[RunPhase, set[RunPhase]] = {
    ...
    RunPhase.FAIL_REPAIRABLE: {RunPhase.REPAIRING, RunPhase.NEEDS_REVIEW, RunPhase.VERIFYING},
    ...
    RunPhase.FAILED_NORMALIZATION: {RunPhase.NORMALIZING, RunPhase.FAILED_NORMALIZATION, RunPhase.FAILED_RUNTIME},
    RunPhase.FAILED_EXTRACTION: {RunPhase.EXTRACTING, RunPhase.FAILED_EXTRACTION, RunPhase.FAILED_RUNTIME},
}
