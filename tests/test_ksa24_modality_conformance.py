...
class KSA24ModalityConformanceTests(unittest.TestCase):
    ...
    def test_chart_trend_and_process_direction_are_bound_to_engine_evidence(self) -> None:
        ...
        process = (
            ...
            {"element_id": "unit-edge", "kind": "connector", "bbox_px": [10, 5, 20, 5], "required": True, "connector": {"from_element_id": "unit-a", "to_element_id": "unit-b", "direction_evidence": "start_to_end", "direction_evidence_source": "ooxml"}},
        )
