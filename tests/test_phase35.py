...
class Phase35Tests(unittest.TestCase):
    ...
    def test_heavy_workflow_persists_host_output_and_requires_capabilities(self):
        ...
        self.assertIn("sha256:d1053354624536b044162aaab1e418bd000ea35184fb1ae098ab3166b1072e72", dockerfile)
        self.assertIn("snapshot.debian.org", dockerfile)
        self.assertIn("k_slide.runtime_artifact", dockerfile)
        ...
        self.assertIn("Verify canonical runtime dependency identity", workflow)
